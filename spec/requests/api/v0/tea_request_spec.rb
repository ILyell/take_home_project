...
describe "Tea Request" do
    ...
    describe "Tea Show Request" do

        it "Returns the tea and status 200" do
        ...
        it 'Returns 404 if Tea not found' do
            ...
            expect(tea[:message]).to eq("Tea not found")
            expect(tea).to have_key(:errors)
